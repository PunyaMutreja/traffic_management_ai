...
class DecisionTreeTrafficController:
    def __init__(self):
        self.model = DecisionTreeRegressor(max_depth=5)  # Using Decision Tree instead of KNN
...
class TrafficLightSystem:
    def __init__(self):
        ...
        self.decision_tree_controller = DecisionTreeTrafficController()  # Changed from KNN
    ...
    def update(self, vehicles):
        ...
        if time_since_change > self.green_duration + self.yellow_duration:
            ...
            # Train/update Decision Tree model
            self.decision_tree_controller.train(self.data_collector.features, 
            ...
            # Get new duration from Decision Tree
            current_state = {
                'north_count': vehicle_counts[NORTH],
                'east_count': vehicle_counts[EAST],
                'south_count': vehicle_counts[SOUTH],
